...
If you need to connect a relational database not supported in Jmix out-of-the-box, follow instructions in the xref:studio:data-stores.adoc#unsupported-database[Studio: Connecting to Unsupported Databases] section.
