...
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/text-field/#constraints" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/create-ui/creating-components/mixins/#hasstyle-interface" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Jmix Studio предоставляет расширенные возможности для ввода `classNames` в свойствах UI-компонентов с помощью xref:studio:view-designer.adoc#classNames-editor[ClassNames Wizard].
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/text-field/#clear-button" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Определяет xref:keyboard-shortcuts.adoc[сочетание клавиш] для вызова события клика, связанного с компонентом. Компонент должен иметь соответствующий обработчик для обработки события клика, в противном случае комбинация клавиш не будет иметь никакого эффекта.
...
В этом примере атрибут `css` используется для применения встроенных стилей к компоненту xref:flow-ui:vc/components/textField.adoc[textField], включая установку цвета фона, границы, отступов и размера шрифта:
...
В примере ниже атрибут `css` используется для предоставления встроенного CSS для компонента xref:flow-ui:vc/components/button.adoc[button].
...
Устанавливает xref:data-model:datatype.adoc[тип данных] содержимого компонента. Возможные значения:
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/date-picker#date-format" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/create-ui/enabled-state" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Определяет xref:keyboard-shortcuts.adoc[сочетание клавиш], которое используется для установки фокуса на этот компонент.
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/create-ui/creating-components/mixins/#hassize-interface" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Вы можете найти xref:vc/layout-rules.adoc#component-sizes[примеры использования] в разделе Правила Компоновки.
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/text-field#basic-features" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Управляет горизонтальным выравниванием компонента внутри его ячейки сетки вдоль горизонтальной оси. Это соответствует CSS-свойству https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/justify-self[justify-self^].
...
Определяет список имен CSS-классов, которые будут установлены для элемента наложения.
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/text-field/#pattern" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/text-field/#placeholder" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/text-field#read-only-disabled" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/tools/collaboration/components/collaboration-binder#eagerly-propagate-values" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++

Задаёт режим изменения значения для компонента. Этот режим определяет, как часто отправляются изменения значения:

* `EAGER` — при каждом изменении пользователем (например, при каждом нажатии клавиши).
* `LAZY` — после того, как пользователь перестанет печатать на время, заданное тайм-аутом.
* `TIMEOUT` — периодически во время ввода, с интервалом, заданным тайм-аутом.
* `ON_BLUR` — когда компонент теряет фокус.
* `ON_CHANGE` — когда значение фиксируется действием изменения.

Для текстовых полей изменения обычно не отправляются при каждом нажатии клавиши.
Используйте `EAGER` для мгновенной валидации, строк поиска и подобного реактивного поведения.
Используйте <<valueChangeTimeout>> для настройки режимов `LAZY` и `TIMEOUT`.
...
Задаёт тайм-аут (в миллисекундах), используемый в <<valueChangeMode>>.

Этот атрибут влияет только на режимы с задержкой (`LAZY`, `TIMEOUT`) и игнорируется в немедленных режимах или режимах с фиксацией значения (`EAGER`, `ON_BLUR`, `ON_CHANGE`)
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/create-ui/basic-features/#visibility" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/date-picker#week-numbers" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
