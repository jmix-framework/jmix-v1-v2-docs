...
https://vaadin.com/docs/v24/flow/create-ui/web-components/introduction-to-webcomponents[Web Components^] можно создавать с нуля на основе библиотек https://polymer-library.polymer-project.org/[Polymer 3^] или https://lit.dev/[Lit^]. После реализации веб-компонента на JavaScript, для него можно создать Java API.
...
<3> Использование https://vaadin.com/docs/v24/flow/create-ui/creating-components/mixins[Vaadin Mixin Interfaces^] для предоставления общих API и поведения по умолчанию для наборов функциональности, встречающихся в большинстве веб-компонентов.
...
TIP: Более подробную информацию о создании пользовательских компонентов можно найти в документации Vaadin: https://vaadin.com/docs/v24/flow/create-ui/creating-components[Creating Components^], https://vaadin.com/docs/v24/flow/create-ui/creating-components/mixins[Using Vaadin Mixin Interfaces^], https://vaadin.com/docs/v24/flow/create-ui/creating-components/events[Using Events with Components&].
