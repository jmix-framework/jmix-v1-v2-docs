...
You can create https://vaadin.com/docs/v24/flow/create-ui/web-components/introduction-to-webcomponents[Web Components^] from scratch based on https://polymer-library.polymer-project.org/[Polymer 3^] or https://lit.dev/[Lit^] libraries. After a JavaScript Web Component is implemented, you can create a Java API for it.
...
<3> Using https://vaadin.com/docs/v24/flow/create-ui/creating-components/mixins[Vaadin Mixin Interfaces^] to provide common APIs and default behavior for sets of functionalities found in most Web Components.
