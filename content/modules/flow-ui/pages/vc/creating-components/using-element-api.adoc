...
This section demonstrates how to create a component using the https://vaadin.com/docs/v24/flow/create-ui/element-api[Element API^] and a single DOM element.
