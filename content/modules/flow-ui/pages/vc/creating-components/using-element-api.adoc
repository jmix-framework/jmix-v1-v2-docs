...
В этом разделе демонстрируется, как создать компонент, используя https://vaadin.com/docs/v24/flow/create-ui/element-api[Element API^] и единственный DOM-элемент.
