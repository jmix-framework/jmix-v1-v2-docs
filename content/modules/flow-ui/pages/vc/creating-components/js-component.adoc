...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/custom-component-js-library" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
TIP: More information about creating custom components can be found in Vaadin documentation: https://vaadin.com/docs/v24/flow/advanced/loading-resources#using-annotations[Importing JavaScript & CSS^], https://vaadin.com/docs/v24/flow/create-ui/web-components[Integrating Web Components^], https://vaadin.com/docs/v24/flow/create-ui/element-api[Element API^].
