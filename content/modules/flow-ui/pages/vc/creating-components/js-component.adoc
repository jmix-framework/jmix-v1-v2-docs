...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/custom-component-js-library" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
TIP: Более подробную информацию о создании пользовательских компонентов можно найти в документации Vaadin: https://vaadin.com/docs/v24/flow/advanced/loading-resources#using-annotations[Импорт JavaScript и CSS^], https://vaadin.com/docs/v24/flow/create-ui/web-components[Интеграция веб-компонентов^], https://vaadin.com/docs/v24/flow/create-ui/element-api[API элементов^].
