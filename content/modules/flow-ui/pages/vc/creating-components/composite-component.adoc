...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/composite-component" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
https://vaadin.com/docs/v24/components/custom-field[CustomField^] — это базовый класс для обертывания нескольких компонентов в одно поле. Он предоставляет стандартные функции ввода, такие как надпись, подсказка и валидация. Используйте его для создания собственных компонентов ввода.
