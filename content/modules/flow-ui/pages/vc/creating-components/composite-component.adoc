...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/composite-component" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
https://vaadin.com/docs/v24/components/custom-field[CustomField^] is a base class for wrapping multiple components into a single field. It provides standard input field features such as label, helper, and validation. Use it to create custom input components.
