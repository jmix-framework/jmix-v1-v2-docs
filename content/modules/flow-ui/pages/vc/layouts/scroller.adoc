...
`scroller` allows displaying content that takes up a lot of space in a smaller area. Components placed inside the scrollable area must be wrapped with a layout component, such as xref:flow-ui:vc/layouts/vbox.adoc[].
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/scroller/#scroll-direction" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
See https://vaadin.com/docs/v24/components/scroller[Vaadin Docs^] for more information.
