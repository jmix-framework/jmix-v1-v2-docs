...
The component's appearance is customizable with the xref:vc/common-attributes.adoc#themeNames[themeNames] attribute, which allows you to select among seven different options:
...
See https://vaadin.com/docs/v24/components/tabs[Vaadin Docs^] for more information.
