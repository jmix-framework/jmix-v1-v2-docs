...
Внешний вид компонента настраивается с помощью атрибута xref:vc/common-attributes.adoc#themeNames[themeNames], который позволяет выбрать среди семи различных вариантов:
...
Дополнительную информацию смотрите в https://vaadin.com/docs/v24/components/tabs[документации Vaadin^].