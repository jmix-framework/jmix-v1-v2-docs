...
Внешний вид компонента настраивается с помощью атрибута xref:vc/common-attributes.adoc#themeNames[themeNames], который позволяет выбрать среди шести различных вариантов:
