...
----
<1> A number without a <<suffix,suffix>> means minutes.
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/time-picker#minimum-maximum-value" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
See https://vaadin.com/docs/v24/components/time-picker[Vaadin Docs^] for more information.
