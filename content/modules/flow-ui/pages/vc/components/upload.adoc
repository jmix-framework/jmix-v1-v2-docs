...
Наш демонстрационный проект Samples содержит https://demo.jmix.ru/ui-samples/sample/upload[пример использования^] `MultiFileMemoryBuffer` для управления несколькими файлами в `com.vaadin.flow.component.upload.SucceededEvent`.
|[[receiver]]receiver
