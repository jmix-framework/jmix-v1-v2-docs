...
Устанавливает видимость флажка **Remember me** ("Запомнить меня").
...
Смотрите {vaadin-docs}/components/login[документацию Vaadin^] для получения дополнительной информации.