...
* https://demo.jmix.ru/ui-samples/sample/entity-picker-actions[entityPicker with actions^]
* https://demo.jmix.ru/ui-samples/sample/entity-picker-meta-class[entityPicker with metaClass^]
