...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/components/tabs#orientation-overflow" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Смотрите {vaadin-docs}/components/tabs[документацию Vaadin^] для получения дополнительной информации.