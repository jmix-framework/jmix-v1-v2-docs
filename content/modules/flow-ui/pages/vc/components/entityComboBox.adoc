...
* https://demo.jmix.ru/ui-samples/sample/entity-combobox-simple[entityCombobox with actions]
* https://demo.jmix.ru/ui-samples/sample/entity-combobox-items-query[entityComboBox with items fetchCallback^]
