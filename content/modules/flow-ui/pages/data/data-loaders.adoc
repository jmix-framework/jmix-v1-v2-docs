...
TIP: Explore the https://demo.jmix.io/ui-samples/sample/custom-filter[Custom filter using declarative conditions^] online example to see query conditions in action.
