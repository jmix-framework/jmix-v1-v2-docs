...
Если загрузчик не имеет атрибута `readOnly="true"` в XML или если xref:flow-ui:data/data-context.adoc[DataContext] установлен для загрузчика программно, все загруженные сущности будут автоматически помещены в data context.
...
TIP: Онлайн-пример https://demo.jmix.ru/ui-samples/sample/custom-filter[Фильтр с использованием декларативных условий^], демонстрирует условия запросов в действии.
