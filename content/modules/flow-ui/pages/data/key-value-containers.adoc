...
[TIP]
====
浏览以下在线示例，了解键值对容器的实际用法：

* https://demo.jmix.io/ui-samples/sample/data-grid-key-value[使用键值对容器的 DataGrid^]
* https://demo.jmix.io/ui-samples/sample/property-filter-key-value[使用键值对容器的 PropertyFilter^]
====
