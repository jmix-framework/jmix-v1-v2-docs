...
* https://demo.jmix.ru/ui-samples/sample/data-grid-key-value[DataGrid с контейнером key-value^]
* https://demo.jmix.ru/ui-samples/sample/property-filter-key-value[PropertyFilter с контейнером key-value^]
====
