...
* `getSaveNotificationText()` - возвращает текст уведомления о сохранении. Стандартная реализация генерирует текст на основе имен сущности и экземпляра. Вы можете переопределить этот метод, чтобы вернуть свой собственный текст.
