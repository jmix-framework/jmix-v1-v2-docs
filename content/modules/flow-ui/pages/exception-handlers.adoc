...
NOTE: By default, `ExceptionDialog` appears as a modal window. This behavior can be customized by setting the xref:flow-ui:ui-properties.adoc#jmix.ui.exception-dialog-modal[jmix.ui.exception-dialog-modal] property in the `application.properties` file.
