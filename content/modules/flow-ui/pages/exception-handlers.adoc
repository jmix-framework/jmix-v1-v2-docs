...
Вы можете настроить диалог, отображаемый обработчиком исключений по умолчанию, настроив специальные CSS-переменные и свойства приложения, или путем расширения Java-класса диалога и реализации собственной логики.
...
[source,css]
----
include::example$/onboarding/frontend/themes/onboarding/onboarding.css[tags=exception-dialog]
----
