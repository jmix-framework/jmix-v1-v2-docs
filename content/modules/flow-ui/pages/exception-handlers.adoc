...
NOTE: По умолчанию `ExceptionDialog` отображается как модальное окно. Это поведение можно изменить, настроив свойство xref:flow-ui:ui-properties.adoc#jmix.ui.exception-dialog-modal[jmix.ui.exception-dialog-modal] в файле `application.properties`.
