...
* `shortcutCombination` - xref:keyboard-shortcuts.adoc[горячая клавиша] для этого элемента меню. Возможные модификаторы - `ALT`, `CTRL`, `SHIFT` - разделяются символом "-". Например:
+
[source,xml,indent=0]
----
