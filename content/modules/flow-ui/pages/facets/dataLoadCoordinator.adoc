...
[source,xml,indent=0]
----
include::example$/onboarding/src/main/resources/com/company/onboarding/view/automaticmode/automatic-mode-view.xml[tags=automatic-mode]
----
...
Фасет можно установить в полуаавтоматический режим. В этом режиме координатор автоматически запускает загрузчики (с `auto = "true"`), *но* также учитывает любые добавленные вами ручные правила.
...
<1> *Фасет в полуаавтоматическом режиме* – фасет будет автоматически запускать загрузчики, если для них не определены иные правила.
