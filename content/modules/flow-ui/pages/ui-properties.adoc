...
This application property controls whether the xref:exception-handlers.adoc#customizing-default-handler[ExceptionDialog] in Jmix applications should be displayed as a modal window.
...
Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to close the current view.

[[jmix.ui.view.save-shortcut]]
=== jmix.ui.view.save-shortcut

Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to save changes.
...
Enables generating special test ids to use with the Masquerade testing library. To learn more, please see xref:testing:masquerade.adoc[Masquerade].
...
This property controls the behavior of xref:vc/components/checkbox.adoc[checkbox] and xref:vc/components/switch.adoc[switch] bound to a mandatory boolean attribute with `@NotNull` validation.

* If `true`, `checkbox`/`switch` must be checked to pass validation.

* If `false`, `checkbox`/`switch` can remain unchecked without causing validation errors. This allows it to represent either a `true` or `false` value as needed.
...
Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to apply current filtering conditions in a xref:vc/components/genericFilter.adoc[genericFilter] component in case they are not <<jmix.ui.component.filter-auto-apply, automatically applied>>.
...
Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to execute xref:actions/list-actions.adoc#list_add[list_add] action.

[[jmix.ui.component.grid-create-shortcut]]
=== jmix.ui.component.grid-create-shortcut

Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to execute xref:actions/list-actions.adoc#list_create[list_create] action.

[[jmix.ui.component.grid-edit-shortcut]]
=== jmix.ui.component.grid-edit-shortcut

Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to execute xref:actions/list-actions.adoc#list_edit[list_edit] action.
...
Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to execute xref:actions/list-actions.adoc#list_read[list_read] action.
...
Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to execute xref:actions/list-actions.adoc#list_remove[list_remove] action.
...
Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to clear input of a picker component.

[[jmix.ui.component.picker-lookup-shortcut]]
=== jmix.ui.component.picker-lookup-shortcut

Defines the xref:keyboard-shortcuts.adoc[keyboard shortcut] that is used to open a lookup view for a picker component.

[[jmix.ui.component.picker-open-shortcut]]
=== jmix.ui.component.picker-open-shortcut

Defines the keyboard xref:keyboard-shortcuts.adoc[shortcut] that is used to open a detail view for the entity selected in a picker component.
