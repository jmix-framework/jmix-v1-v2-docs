...
Это свойство приложения определяет, должен ли `ExceptionDialog` отображаться как модальное окно в Jmix-приложениях.
...
Включает генерацию специальных тестовых идентификаторов для использования с библиотекой тестирования Masquerade. Чтобы узнать больше, посетите раздел xref:testing:masquerade.adoc[Masquerade].
