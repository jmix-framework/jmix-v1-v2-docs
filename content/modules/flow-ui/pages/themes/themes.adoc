...
Jmix 提供了基于 Vaadin https://vaadin.com/docs/latest/styling/lumo[Lumo^] 主题构建的 *jmix-lumo* 主题。
...
* `my-project` - 主题文件夹。其名称作为 <<applying-theme,@Theme>> 注解的主题名称。
...
[TIP]
====
使用 Vaadin 的在线 https://demo.vaadin.com/lumo-editor/[Lumo 主题编辑器^] 可以快速自定义应用程序的主题。
