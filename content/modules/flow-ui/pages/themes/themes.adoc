...
Jmix предоставляет тему *jmix-lumo*, построенную на основе темы https://vaadin.com/docs/v24/styling/lumo[Lumo^] Vaadin.
...
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v24/styling/advanced/multi-app-themes" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
