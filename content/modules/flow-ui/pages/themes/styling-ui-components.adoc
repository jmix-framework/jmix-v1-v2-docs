...
Another option is to use CSS properties – either the built-in https://vaadin.com/docs/v24/styling/lumo/lumo-style-properties[Lumo properties^] or custom ones – that are statically applied using CSS, but whose values are set through application logic:
