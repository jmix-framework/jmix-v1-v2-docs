...
[[multiple-wars]]
=== Развертывание нескольких WAR файлов

Развёртывание нескольких WAR файлов Jmix на одном сервере Tomcat может привести к конфликту имён JMX бинов, вызывая ошибку:

----
Caused by: javax.management.InstanceAlreadyExistsException: jmix.ui:type=TemporaryStorage
----

Чтобы устранить проблему, задайте каждому WAR файлу собственный JMX домен. Для этого добавьте следующее в файл свойств приложения:
