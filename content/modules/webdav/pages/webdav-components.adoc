...
* Воспользуетесь компонентом xref:webdav:ui-components.adoc#webdav-document-upload-field[webdavDocumentUpload] на экране деталей оболочки документа webDav, чтобы загружать документ WebDAV в систему.
