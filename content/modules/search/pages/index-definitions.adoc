...
The granularity of the prefix generation is controlled via xref:search-properties.adoc#jmix.search.minPrefixLength[jmix.search.minPrefixLength] and xref:search-properties.adoc#jmix.search.maxPrefixLength[jmix.search.maxPrefixLength] application properties.
