...
Дополнение использует https://www.elastic.co[Elasticsearch^] или https://opensearch.org[OpenSearch^] (начиная с Jmix 2.3) в качестве поисковой системы. Оно может работать только с одной из них одновременно.
...
CAUTION: Обратите внимание, что дополнение Search в настоящее время не совместимо с сервисом Elasticsearch, предлагаемым AWS.
