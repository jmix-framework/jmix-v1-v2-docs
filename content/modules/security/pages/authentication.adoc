...
<1> `InteractiveAuthenticationSuccessEvent` посылается, когда пользователь входит в систему через UI.
...
Подробнее см. в {vaadin-docs}/flow/advanced/application-lifecycle#application.lifecycle.session[документации Vaadin: User Session^].
