...
<1> `InteractiveAuthenticationSuccessEvent` is sent when a user logs in to the system through UI.
...
See also {vaadin-docs}/flow/advanced/application-lifecycle#application.lifecycle.session[Vaadin Documentation: User Session^] for more information.
