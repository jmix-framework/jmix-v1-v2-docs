...
* The *System* flag designates a report for internal system use. System reports can be executed only through the xref:run-report.adoc#reports-api[API]. They are hidden in UI of the xref:run-report.adoc#run-actions[report actions] and in the xref:run-report.adoc#run-from-list[Run report] view.
...
* `system` -- sets the system flag for the report. System reports can be executed only through the xref:run-report.adoc#reports-api[API]. They are hidden in UI of the xref:run-report.adoc#run-actions[report actions] and in the xref:run-report.adoc#run-from-list[Run report] view.