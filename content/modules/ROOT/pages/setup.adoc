...
To enable an AI agent to work effectively with Jmix patterns, architecture, and best practices, we recommend using the https://github.com/jmix-framework/jmix-agent-guidelines[Jmix AI Agent Guidelines^]. These guidelines provide:
