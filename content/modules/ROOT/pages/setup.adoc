...
Скачайте JDK версии 17 или 21 (например, https://adoptium.net/temurin/releases/?version=17[Eclipse Temurin^] или https://axiomjdk.ru[Axiom JDK^]) и установите в каталог, предложенный установщиком. Этого достаточно для создания и запуска приложений в IDE.
