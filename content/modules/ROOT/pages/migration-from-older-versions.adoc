...
. Install the latest Jmix agent skills, instructions and tools from the https://github.com/jmix-framework/jmix-agent-toolkit/tree/v2[jmix-framework/jmix-agent-toolkit^] repository.
