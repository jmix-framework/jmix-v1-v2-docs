...
To get a xref:studio:subscription.adoc#sprint-subscription[Sprint] trial subscription, you should log in to the Jmix account via Jmix Studio. After that, a trial subscription for 28 days is activated.

[[enterprise-trial]]
=== Enterprise+BPM Trial

To try out the commercial add-ons provided by the xref:studio:subscription.adoc#enterprise-subscription[Enterprise and BPM] subscriptions, visit your profile page at https://store.jmix.io/account[^] and click on the *Get Enterprise+BPM trial* button in the *Subscription* section.

image::store/get-enterprise-trial.png[align="center", width="1260"]

After that, the trial subscription is activated, and the *Download Enterprise+BPM trial* button appears.
...
CAUTION: Trial versions of commercial add-ons will stop working in 28 days after requesting the trial subscription. An application including expired trial add-ons will not run.
...
To buy a Sprint, Enterprise, or BPM subscription:
...
You can upgrade a plan and decrease or increase the number of users.
