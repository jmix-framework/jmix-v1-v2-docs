...
NOTE: This step only adds attributes to the SAML assertion. The application will not use them automatically. To fill application user attributes from these values, you must also configure xref:saml:additional-setup.adoc#_adding_extra_saml_attributes[attribute mapping] in the application.
