...
Create the *Today* parameter and set its type to `Date`:
...
Look for the notification indicator, located in the upper-right corner of the main view, and click it. The *In-app notifications* dialog window will appear, showing a list of unread or recent notifications:
