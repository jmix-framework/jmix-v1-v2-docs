...
CAUTION: The *Message Templates* add-on cannot be used with Oracle Database versions prior to 12.2 because older versions have limits on the length of database object names.
