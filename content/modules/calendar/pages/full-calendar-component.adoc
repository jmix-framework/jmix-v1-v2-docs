...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
<<eventSingleClickThreshold, eventSingleClickThreshold>> -
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-simple-calendar-event" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-recurring-events" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-container-calendar-data-provider" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-list-calendar-data-provider" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-callback-calendar-data-provider" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-callback-load-delegate" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-calendar-data-retriever" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-calendar-display-modes" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-display-mode-specific-properties" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-custom-calendar-display-mode" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-generic-calendar-display-modes" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-event-start-editable" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-event-duration-editable" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-event-constraint" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-event-overlap-function" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-selection" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-select-overlap-function" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-business-hours" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-context-menu" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-event-styling" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-class-names-generator" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
* xref:defaultDayHeaderFormat[defaultDayHeaderFormat]: Определяет формат текста для заголовков столбцов календаря.

* xref:defaultDayPopoverFormat[defaultDayPopoverFormat]: Определяет формат даты для заголовка всплывающего окна, которое появляется при нажатии на ссылку "еще" в ячейке.

* xref:defaultEventTimeFormat[defaultEventTimeFormat]: Определяет формат времени, отображаемого для каждого события в календаре.

* xref:defaultSlotLabelFormat[defaultSlotLabelFormat]: Устанавливает формат текста, который будет отображаться внутри временного интервала.

* xref:defaultWeekNumberFormat[defaultWeekNumberFormat]: Определяет формат отображения номера недели, который отображается, когда включено свойство <<weekNumbersVisible,weekNumbersVisible>>.

По умолчанию компонент устанавливает локализованный формат из `messages` при создании.

=== Приоритет форматов

Свойства формата по умолчанию служат запасным вариантом для всех стандартных режимов отображения (`dayGridDay`, `timeGridWeek` и т. д.) и любых пользовательских режимов (xref:custom-calendar-display-mode[CustomCalendarDisplayMode]) до тех пор, пока на уровне режима отображения не будет определен более специфичный формат.
...
[source,xml,indent=0]
----
include::example$fullcalendar-ex2/src/main/resources/com/company/fullcalendarsample/view/demos/displaymode/day-grid-day-mode-view.xml[tags=dayGridDay]
----

=== Правила форматирования

Этот компонент использует https://fullcalendar.io/docs/moment-plugin[плагин moment^] для `FullCalendar`. Поэтому все строки форматирования должны соответствовать правилам форматирования, определённым в https://momentjs.com/docs/#/displaying/format/[документации Moment.js^].
...
[NOTE]
====
Изменения этих свойств (например, программное обновление `defaultDayHeaderFormat`) не будут применены после того, как компонент будет прикреплен к UI и отрисован. Чтобы изменить форматы во время выполнения, вам потребуется перестроить UI календаря или полностью переотрисовать компонент.
====
...
[source,xml,indent=0]
----
include::example$fullcalendar-ex2/src/main/resources/com/company/fullcalendarsample/view/demos/displaymode/time-grid-week-mode-view.xml[tags=time-grid-week-mode2]
----

*Пример 2: Вид List Week*
...
[source,xml,indent=0]
----
include::example$fullcalendar-ex2/src/main/resources/com/company/fullcalendarsample/view/demos/displaymode/list-week-mode-view.xml[tags=list-week-mode-format]
----
...
Например, `dd` создает значение `"Mo"`.

Смотрите подраздел <<formatting,Форматирование>>.
|-
...
|[[defaultDayPopoverFormat]]defaultDayPopoverFormat
|Устанавливает формат даты заголовка всплывающего окна, которое отображается при нажатии на ссылку "подробнее".

Например, `MMM D, YY` создает значение `Sep 9, 24`.

Смотрите подраздел <<formatting,Форматирование>>.
|-

|[[defaultEventTimeFormat]]defaultEventTimeFormat
|Устанавливает формат текста времени, который будет отображаться на каждом событии.

Например, `HH:mm` создает значение `00:00` (01, 2, ... 23 : 01, 02 ... 59).

Смотрите подраздел <<formatting,Форматирование>>.
|-

|[[defaultSlotLabelFormat]]defaultSlotLabelFormat
|Устанавливает формат текста, который будет отображаться в пределах временного интервала.

Например, `ha` создает значение `1 am` (1, 2, ... 12 am/ pm).
...
|[[defaultWeekNumberFormat]]defaultWeekNumberFormat
|Устанавливает формат номера недели, который будет отображаться, когда <<weekNumbersVisible, weekNumbersVisible>> равно `true`.

Например, `[Week] w` создает значение `Week 1` (1, 2, ... 52, 53).
...
|[[eventSingleClickThreshold]]eventSingleClickThreshold
|Specifies the delay (in milliseconds) before a single-click event is triggered. This threshold is used to distinguish a single click from a double-click action.
Please note, this attribute is supported in Jmix 2.7.2 and later.
|`250`
...
The calendar click event includes `MouseEventDetails`, providing specific information about the mouse interaction:

* `clickCount`: number of consecutive clicks (1 for single-click, 2 for double-click). Please note, this attribute is supported in Jmix 2.7.2 and later.

* `button`: which mouse button was pressed (`LEFT`, `MIDDLE`, `RIGHT`).

* `pageX/pageY`: document-relative coordinates of the click.

* Modifier keys: state of `Alt`, `Ctrl`, `Meta` (`Cmd` on macOS), and `Shift` keys during the click.

|[[EventDoubleClickEvent]]EventDoubleClickEvent
|`io.jmix.fullcalendarflowui.component.event.EventDoubleClickEvent` is fired when a user double-clicks on a calendar event.

Please note, this functionality is supported in Jmix 2.7.2 and later.

`EventDoubleClickEvent` includes <<EventClickEvent,MouseEventDetails>>, providing specific information about the mouse interaction.
...
|[[EventSingleClickEvent]]EventSingleClickEvent
|`io.jmix.fullcalendarflowui.component.event.EventSingleClickEvent` is fired when a user clicks on a calendar event. To distinguish it from a double-click, the event is dispatched after a short delay. You can configure this delay via the <<eventSingleClickThreshold,eventSingleClickThreshold>> attribute.

Please note, this functionality is supported in Jmix 2.7.2 and later.

`EventSingleClickEvent` includes <<EventClickEvent,MouseEventDetails>>, providing specific information about the mouse interaction.
...
|monthStartFormat
|Задает формат текстового формата для первой ячейки каждого месяца.

Например, «MMMM» дает сентябрь (ноябрь, декабрь и т. д.).
...
|listDayFormat
|Задает формат текста в левой части заголовков дня.

Например, «dd» дает пн (понедельник).

Смотрите подраздел <<formatting,Форматирование>>.
|-

|listDaySideFormat
|Задает формат текста в правой части заголовков дня.
...
|Задает формат текста над каждым месяцем.

Например, `"MMM"` дает `Сен (Ноя, …)`.
