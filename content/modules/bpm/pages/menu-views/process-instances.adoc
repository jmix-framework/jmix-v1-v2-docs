...
* *Diagram tab* — visualizes the process diagram and highlights the currently active node. Supports panning and zooming.
+
image::bpm-menu-views/process-instance-diagram.png[width=989]