...
`@ProcessVariable` can be set on class fields and view components. It indicates that the process variable's value will be set to that field when the process form opens.
...
In the case of a view component, the variable's value will be set in that component.
