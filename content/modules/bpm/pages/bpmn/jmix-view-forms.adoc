...
Аннотация `@ProcessVariable`  может применятся к полям класса и компонентам экрана. При открытии экрана процессной формы значение указанной переменной процесса автоматически записывается в помеченное поле.
...
Если аннотация установлена на компонент, значение переменной будет установлено в этот компонент.
