...
Overall, pools and lanes in BPMN help are aimed to improve communication and collaboration between different stakeholders involved in a business process.
