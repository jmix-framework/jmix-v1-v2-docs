...
You can also use the `current_locale` predefined query parameter in the same way as parameters with the `current_user_` prefix.

For example, you can write a JPQL query like this:
