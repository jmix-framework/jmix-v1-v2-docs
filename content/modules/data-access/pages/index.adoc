...
If you need to execute complex SQL queries, perform batch operations, or invoke stored procedures, consider using xref:jdbc.adoc[JDBC] wrappers provided by Spring.