...
* A type that have a corresponding xref:data-model:data-types.adoc[Datatype]. These include types supported in xref:data-model:entities.adoc#attributes[entity attributes], as well as custom data types.
