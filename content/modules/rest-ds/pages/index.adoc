...
* Тип, для которого существует соответствующий xref:data-model:data-types.adoc[Datatype]. Сюда входят типы, поддерживаемые в xref:data-model:entities.adoc#attributes[атрибутах сущностей], а также пользовательские типы данных.
