...
* Репозитории даннх Jmix теперь поддерживают запросы, возвращающие скалярные значения и агрегаты. См. примеры использования аннотации xref:data-access:data-repositories.adoc#query-annotation[@Query].
