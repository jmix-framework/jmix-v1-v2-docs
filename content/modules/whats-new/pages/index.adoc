...
Боковая панель может открываться с разных сторон и либо перекрывать основной контент, либо сдвигать его. Подробности и примеры использования см. в xref:flow-ui:vc/layouts/sidePanelLayout.adoc[].adoc[].
