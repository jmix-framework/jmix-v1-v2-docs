...
Определяет комбинацию клавиш, которую можно использовать для применения условия фильтрации. Эта комбинация клавиш актуальна только в том случае, если условия фильтрации не настроены для <<autoApply,автоматического применения>>.

Значение по умолчанию определяется свойством xref:app-properties.adoc#jmix.ui.component.filter-apply-shortcut[jmix.ui.component.filter-apply-shortcut].
