...
Apart from messages, the message bundle can also contain xref:data-model:datatype.adoc#localized-format-strings[localized data format strings].
...
When you create a new project using Studio, you can set up the list of supported locales in the *Locales* field of the project wizard. This field allows you to select languages and their codes.
