...
In the *Locales* tab, you can set locales used in your application. The editor also enables defining or overriding format strings for xref:data-model:datatype.adoc#localized-format-strings[parsing and formatting data].
