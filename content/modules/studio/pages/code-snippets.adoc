...
image::snippet-window.png[align="center",width="645"]
...
image::snippet-example.png[align="center",width="784"]

The result of adding the code snippet will be the following:

image::snippet-example-result.png[align="center",width="784"]
...
image::snippet-query.png[align="center",width="952"]

In the result, the following code will be added:

image::snippet-query-result.png[align="center",width="762"]
