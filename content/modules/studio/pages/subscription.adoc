...
* Расширенная поддержка xref:studio:data-repository-wizard.adoc[репозиториев данных]
* Расширенная поддержка генерации клиентов по xref:openapi-integration-guide:index.adoc[OpenAPI]
