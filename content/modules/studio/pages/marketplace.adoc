...
image::add-ons-open.png[align="center",width="248"]
...
image::add-ons-info.png[align="center",width="942"]
...
image::add-ons-installed.png[align="center",width="877"]
...
image::add-ons-button.png[align="center", width="877"]
...
image::add-ons-coordinates.png[align="center", width="661"]