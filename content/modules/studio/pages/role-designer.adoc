...
image::role-definition.png[align="center", width="724"]
...
在 *User Interface* 标签页，可以定义菜单项和视图权限。

image::role-user-interface.png[align="center", width="724"]
...
image::role-entities.png[align="center", width="724"]
...
image::role-specific.png[align="center", width="724"]
