...
image:menu-suggest.png[align="center",width="585"]
...
image:menu-single.png[align="center",width="724"]
...
image:menu-create-item.png[align="center",width="898"]
