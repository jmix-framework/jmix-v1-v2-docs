...
For more information, refer to the https://docs.spring.io/spring-boot/reference/features/external-config.html#features.external-config.files.importing-extensionless[Spring Boot documentation on external configuration^].