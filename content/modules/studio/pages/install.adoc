...
+
image::idea-proxy.png[align="center",width="1012"]
...
image::idea-offline.png[align="center",width="436"]
...
+
image::jmix-site.png[align="center",width="1331"]
+
. Open the *Main Menu → File → Settings → Plugins* dialog in IntelliJ IDEA.
. Click the gear icon and select *Install Plugin from Disk*.
+
image::install-from-disk.png[align="center",width="1094"]
+
