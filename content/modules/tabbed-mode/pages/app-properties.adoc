...
Defines the keyboard shortcut that is used to execute xref:main-tab-sheet.adoc#tabmod_closeThisTab[tabmod_closeThisTab] action.

[[jmix.tabmod.close-other-tabs-shortcut]]
== jmix.tabmod.close-other-tabs-shortcut

Defines the keyboard shortcut that is used to execute xref:main-tab-sheet.adoc#tabmod_closeOtherTabs[tabmod_closeOtherTabs] action.

[[jmix.tabmod.close-all-tabs-shortcut]]
== jmix.tabmod.close-all-tabs-shortcut

Defines the keyboard shortcut that is used to execute xref:main-tab-sheet.adoc#tabmod_closeAllTabs[tabmod_closeAllTabs] action.