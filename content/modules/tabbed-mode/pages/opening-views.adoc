...
When opening a list view for lookup using `viewBuilders.lookup(this, SomeEntity.class)`, the framework selects a view according to the following order:
...
When opening a detail view using `viewBuilders.detail(this, SomeEntity.class)`, the framework selects a view according to the following order:
