...
+
It can help add some nontrivial holidays, like the _Third Friday of every month_ or the _First Monday of July_.
...
On the *Additional business days* tab, you can set days that you want to always be treated as business days. If such a date coincides with a holiday, it will still be a workday. There is an option to set different working hours.
...
A business calendar created at design time is displayed in the list of all business calendars and is available only for viewing.
